...
//   // Simulate loading questions (in production, fetch from API)
//   useEffect(() => {
//     // Mock data - replace with actual API call
//     const mockQuestions = [
//       { id: 1, text: "What's your favorite memory of us together?" },
//       { id: 2, text: "How do you feel when you think about our friendship/relationship?" },
//       { id: 3, text: "What's something you've always wanted to tell me but never did?" },
//       { id: 4, text: "What makes you smile when you think of me?" },
//       { id: 5, text: "How would you describe our bond in three words?" }
//     ];
    
//     setQuestions(mockQuestions);
//     setSenderName("Alex"); // Mock sender name
//     setRecipientName("You"); // Mock recipient
...
//     // In production, send answers to backend
...
//               lineHeight: "1.8"
//             }}>
//               Take your time and answer from the heart. Your responses will be shared with {senderName}. 💝
//             </p>
//           </motion.div>
...
//             ) : (
//               <motion.button
//                 whileHover={{ scale: 1.02, boxShadow: "0 15px 40px rgba(76,175,80,0.4)" }}
//                 whileTap={{ scale: 0.98 }}
...
//               marginBottom: "2rem"
//             }}>
//               Your heartfelt answers have been sent to <strong style={{ color: "#ff9800" }}>{senderName}</strong>!
...
import RespondentInfoForm from "@/components/RespondentInfoForm";
